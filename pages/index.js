...
export default function Component() {
          ...
          <div className={styles.secondbar}>
            ...
            <button onClick={() => signOut()}>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-2 h-2">
                ...
                clipRule="evenodd" />
                <path fillRule="evenodd" d="M6 10a.75.75 0 01.75-.75h9.546l-1.048-.943a.75.75 0 111.004-1.114l2.5 2.25a.75.75 0 010 1.114l-2.5 2.25a.75.75 0 11-1.004-1.114l1.048-.943H6.75A.75.75 0 016 10z" 
                clipRule="evenodd" />
              </svg>
            </button>
  ...
  return (
    <div className={styles.main}>
      <button onClick={() => signIn('google')} className={styles.btn}>Login with Google</button>
    </div>
  )
}
